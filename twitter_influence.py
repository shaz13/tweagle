...
if __name__ == '__main__':
    ...
    timeline_file1 = 'users/{u}/user_timeline_{u}.jsonl'.format(u = screen_name1)
    timeline_file2 = 'users/{u}/user_timeline_{u}.jsonl'.format(u = screen_name2)
    ...
    print "=="*30
    print "Influence relation between {} and {}".format(screen_name1,screen_name2)
    print "=="*30
